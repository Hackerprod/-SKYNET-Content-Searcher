...
namespace SKYNET.Controles
{

    public sealed class HackProgressBar : Control
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            base.OnResize(e);
            this.Height = 20;
            Size minimumSize = new Size(58, 5);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.Clear(Color.FromArgb(28, 29, 32));
            ...
            if (I1 > 1)
            {
                ...
                if (_DrawHatch == true)
                {
                    ...
                    {
                        G.DrawLine(new Pen(new SolidBrush(Color.FromArgb(25, Color.FromArgb(28, 29, 32))), 10.0F), new Point(System.Convert.ToInt32(i), 0), new Point((int)(i - 10), Height));
                    }
                }
